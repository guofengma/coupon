...
PDFJS.imageResourcesPath =  basePath+'/assets/pdfjs/web/images/';
  PDFJS.workerSrc =  basePath+'/assets/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl =  basePath+'/assets/pdfjs/web/cmaps/';
